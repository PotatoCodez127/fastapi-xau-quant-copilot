...
def sample_market_data() -> pd.DataFrame:
    ...
    timestamps = pd.date_range(start="2026-01-01 00:00:00", periods=20, freq="5min", tz="UTC")
    data = {
...
async def test_fetch_twelvedata_async_error_handling():
    ...
    result_df = await fetch_twelvedata_async(mock_client, symbol="XAU/USD", outputsize=10)
